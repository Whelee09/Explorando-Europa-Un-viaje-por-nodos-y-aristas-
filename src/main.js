...
mapa.set(7, { codigo: "VIE", ciudad: "Viena", pais: "Austria", activo: false });
mapa.set(8, { codigo: "LED", ciudad: "San Petersburgo", pais: "Rusia", activo: false });
mapa.set(9, { codigo: "LIS", ciudad: "Lisboa", pais: "Portugal", activo: false });
//mapa.set(10, { codigo: "PRG", ciudad: "Praga", pais: "República Checa", activo: false });
//mapa.set(11, { codigo: "IST", ciudad: "Estambul", pais: "Turquía", activo: false });
